    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Demo Bootcamp November</h1>
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a href="/login"
                            class="inline-block dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-1.5 bg-blue-600 rounded-sm border border-black text-white text-sm leading-normal">
