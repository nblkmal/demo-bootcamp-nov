<x-layouts.app>
    ...
    <div class="bg-white rounded-lg p-4 gap-4 flex flex-col">
        ...
        <form action="{{ route('expenses.store') }}" method="POST">
            ...
            <button type="submit" class="bg-black">Save</button>
        </form>
    </div>

    <div class="rounded-md bg-white p-4 mt-6">
        @foreach ($expenses as $expense)
            <div class="flex gap-4 mb-6">
                ...
                <form action="{{ route('expenses.destroy', $expense) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button class="bg-black border">Delete</button>
                </form>
                <a href="{{ route('expenses.edit', $expense) }}">Edit</a>
                {{-- <a href="https://sjhdbvskd">Edit</a> --}}
